...
const ContactForm = () => {
    ...
    return (
        <Div id="contact" className='max-w-[1200px] mt-20  md:mx-10 sm:mx-10 lg:mx-10 lg:pl-40'>
            <ToastContainer />
