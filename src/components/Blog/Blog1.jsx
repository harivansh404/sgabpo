...
const Blog1 = () => {
    return (
        <div className="flex justify-center items-center">
            <div className="2xl:mx-auto 2xl:container shadow-md bg-gradient-to-r from-green-400 to-blue-500  lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
