...
const ContectForm = () => {
    ...
    return (
        <Div className="max-w-[1200px] mt-20  md:mx-10 sm:mx-10 lg:mx-10 lg:pl-40">
            <ToastContainer />
            ...
            >
                ...
                {/* SUBMIT BUTTON */}
                <button className="bg-[#111111] h-[64px] lg:ml-80 max-w-[585px]     md:mx-48 md:w-[20rem] text-[16px] transition-transform active:scale-[0.95]">
